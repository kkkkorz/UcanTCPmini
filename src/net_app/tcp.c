...
{
    //拆封数据包
    tcp_packet *tcp_packet_receive = (tcp_packet *)(ip_packet_receive + 1);
    //校验和
    ...
    // --- 握手响应处理 (客户端收到服务器的回应) ---
        ...
        handle_tcp_syn_ack(ip_packet_receive, tcp_packet_receive);
    } 
    ...
    // --- 握手请求处理 (服务器收到客户端的请求) ---
        ...
        handle_tcp_syn(ip_packet_receive, tcp_packet_receive);
    } 
